...
class SliderPicAdapter(private var list:List<Picture>) : RecyclerView.Adapter<SliderPicAdapter.PicViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PicViewHolder{
        return PicViewHolder(
            SliderPictureListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
    ...
    class PicViewHolder(private val binding:SliderPictureListBinding) : RecyclerView.ViewHolder(binding.root){
